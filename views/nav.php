<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">TUGAS WEB LANJUT <small class="text-muted"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown <?php if (isset($data['induk'])): ?><?php echo ($data['induk'] == 'Laporan') ? 'active' : ''; ?> <?php endif;?>">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item <?php echo ($data['link'] == 'Inventaris') ? 'active' : ''; ?>  " href="?hal=Inventaris">Laporan Owner</a>

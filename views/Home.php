<div class="row ">
    <div class="col-12 col-lg-6 mb-2">
        <div class="card rounded shadow mb-2" style="zoom:85%">
            ...
            <div class="jumbotron">
                <h1 class="text-center h2">“MEWUJUDKAN PENGELOLAAN BARANG YANG TRANSPARAN, AKUNTABEL, DAN RESPONSIF” </h1>
            </div>
        </div>
        <div class="card rounded shadow mb-2" style="zoom:85%">
            ...
            <div class="jumbotron p-3 ">
                <div class="d-flex">
                    <span class="mb-0 px-3 mb-2 py-2 shadow text-wrap bg-white rounded-pill ">
                        1. MEWUJUDKAN PENIGKATAN PENGELOLAAN BARANG
                    </span>
                </div>
                <div class="d-flex">
                    <span class="mb-0 px-3 mb-2 py-2 shadow text-wrap bg-white rounded-pill ">
                        2. TERLAKSANANYA TERTIB PENGELOLAAN DAN PENCATATAN BARANG
                    </span>
                </div>
                <div class="d-flex">
                    <span class="mb-0 px-3 mb-2 py-2 shadow text-wrap bg-white rounded-pill ">
                        3. TERLAKSANANYA SISTEM DAN PROSEDUR PENELOLAAN BARANG
                    </span>
                </div>
                <div class="d-flex">
                    <span class="mb-0 px-3 mb-2 py-2 shadow text-wrap bg-white rounded-pill ">
                        4. TERLAKSANNYA PENYUSUNAN, PELAKSANAAN, PERTANGGUNGJAWABAN BARANG YANG TRANSPARAN
                    </span>
                </div>
            </div>
        </div>

        ...
        <div class="card" style="zoom:85%">
            ...
            <div class="" style="zoom:100%" id="print22">
                ...
                <div class="row ">
                    ...
                    <div class="col-10">
                        <br>
                        <h4 class="text-center"><b><u>Laporan Owner</u></b></h4>
                        ...
                        <table style="zoom:100%" class="table card-table table-bordered p-2 table-vcenter" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php endif;?>
                                    <?php endforeach;?>
                                    <td><?php echo $data['transaksi']->where('jenis', 'Masuk')->sum('qty'); ?></td>
                                    <td><?php echo $data['transaksi']->where('jenis', 'Keluar')->sum('qty'); ?></td>
